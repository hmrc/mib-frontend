...
//Extend showhide function for radio buttons with address selector and js disabled - adjusted the css selector

 function ShowHideContentAcc () {
     var self = this

     // Radio and Checkbox selectors
     var selectors = {
       namespace: 'ShowHideContent',
       radio: 'input[type="radio"][data-target]',
  ...
  ShowHideContentAcc.prototype.init = function ($container) {
       this.showHideRadioToggledContent($container)
       this.showHideCheckboxToggledContent($container)
     }

var showHideContentAcc = new ShowHideContentAcc()
showHideContentAcc.init()

   $('.divukaddress').removeClass('divukaddress')
   $('.divnon-ukaddress').removeClass('divnon-ukaddress')
