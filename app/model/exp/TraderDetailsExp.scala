...
case class TraderDetailsExp(trader: String, line1: String, line2: Option[String] = None, city: Option[String] = None, county: Option[String] = None,
...
object TraderDetailsExp {

  object Key {
    val Trader = "traderExp"
    val Line1 = "line1Exp"
    val Line2 = "line2Exp"
    val City = "cityExp"
    val Postcode = "postcodeExp"
    val County = "countyExp"
    val Country = "countryExp"
    val Vrn = "vrnExp"
    val VehicleRegNo = "vehicleRegNoExp"
  }
  ...
  def fromSession(session: Session): Option[TraderDetailsExp] = {
  ...
  def toSession(page2: TraderDetailsExp): Seq[(String, String)] = {
    Map(
